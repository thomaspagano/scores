...
def _block_bootstrap(  # pylint: disable=too-many-locals
    ...
    References:
        - Wilks, D. S. (2020). Statistical methods in the atmospheric sciences
          (4th ed.). Elsevier.
...
def block_bootstrap(
    ...
    *,  # Enforce keyword-only arguments
    ...
    Examples:
        ...
        <BLANKLINE>
            [[15.1, 15.3, 12. , 13.3, 15.1],
                [15.2, 15. , 12.1, 13. , 15.2],
                [15.1, 15.3, 12. , 13.1, 15. ],
                [15.2, 15. , 12.1, 13.2, 15.1]],
        <BLANKLINE>
            [[10.1, 10.3, 13. , 14.3, 10.1],
                [10.2, 10. , 13.1, 14. , 10.2],
                [10.1, 10.3, 13. , 14.1, 10. ],
                [10.2, 10. , 13.1, 14.2, 10.1]]])
        Coordinates:
